...
```java
CompletableFuture<ApiResponse<ResponseTicket>> createaTicketrecordAsync(
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` getter of this instance returns the response data which is of type [`ResponseTicket`](../../doc/models/response-ticket.md).
...
```java
CompletableFuture<ApiResponse<ResponseTicketsCollection>> listallticketsrelatedAsync(
    final Page1 page,
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` getter of this instance returns the response data which is of type [`ResponseTicketsCollection`](../../doc/models/response-tickets-collection.md).
...
```java
CompletableFuture<ApiResponse<ResponseTicket>> viewsingleticketrecordAsync(
