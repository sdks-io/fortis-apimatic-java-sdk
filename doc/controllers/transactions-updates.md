...
transactionsUpdatesController.voidAsync(transactionId, null).thenAccept(result -> {
...
```java
String transactionId = "11e95f8ec39de8fbdb0a4f1a";
V1TransactionsVoidRequest body = new V1TransactionsVoidRequest.Builder()
    .description("some description")
    .build();
...
```java
String transactionId = "11e95f8ec39de8fbdb0a4f1a";
V1TransactionsAuthCompleteRequest body = new V1TransactionsAuthCompleteRequest.Builder()
...
transactionsUpdatesController.authCompleteAsync(transactionId, body, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
```java
String transactionId = "11e95f8ec39de8fbdb0a4f1a";
V1TransactionsAuthIncrementRequest body = new V1TransactionsAuthIncrementRequest.Builder(
    1
)
.checkinDate("2021-12-01")
.checkoutDate("2021-12-01")
...
transactionsUpdatesController.authIncrementAsync(transactionId, body, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
```java
String transactionId = "11e95f8ec39de8fbdb0a4f1a";
V1TransactionsPartialReversalRequest body = new V1TransactionsPartialReversalRequest.Builder(
    1
)
.checkinDate("2021-12-01")
.checkoutDate("2021-12-01")
...
```java
String transactionId = "11e95f8ec39de8fbdb0a4f1a";
V1TransactionsRefundRequest body = new V1TransactionsRefundRequest.Builder()
    .checkinDate("2021-12-01")
    .checkoutDate("2021-12-01")
    .clerkNumber("AE1234")
    .contactId("11e95f8ec39de8fbdb0a4f1a")
...
```java
String transactionId = "11e95f8ec39de8fbdb0a4f1a";
V1TransactionsTipAdjustRequest body = new V1TransactionsTipAdjustRequest.Builder(
    0,
    1
)
.checkinDate("2021-12-01")
...
transactionsUpdatesController.tipAdjustmentAsync(transactionId, body, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
