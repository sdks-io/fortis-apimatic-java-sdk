...
* [Createanewsignaturerecord](../../doc/controllers/signatures.md#createanewsignaturerecord)
* [Listallsignaturesrecord](../../doc/controllers/signatures.md#listallsignaturesrecord)
* [Viewsinglesignaturerecord](../../doc/controllers/signatures.md#viewsinglesignaturerecord)


# Createanewsignaturerecord

```java
CompletableFuture<ApiResponse<ResponseSignature>> createanewsignaturerecordAsync(
    final V1SignaturesRequest body,
    final List<Expand34> expand)
```
...
| `expand` | [`List<Expand34>`](../../doc/models/expand-34.md) | Query, Optional | Most endpoints in the API have a way to retrieve extra data related to the current record being retrieved. For example, if the API request is for the accountvaults endpoint, and the end user also needs to know which contact the token belongs to, this data can be returned in the accountvaults endpoint request.<br><br>**Constraints**: *Unique Items Required* |

## Response Type

This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` getter of this instance returns the response data which is of type [`ResponseSignature`](../../doc/models/response-signature.md).

## Example Usage

```java
V1SignaturesRequest body = new V1SignaturesRequest.Builder(
...
signaturesController.createanewsignaturerecordAsync(body, null).thenAccept(result -> {
...
# Listallsignaturesrecord

```java
CompletableFuture<ApiResponse<ResponseSignaturesCollection>> listallsignaturesrecordAsync(
    final Page1 page,
...
| `fields` | [`List<Field45>`](../../doc/models/field-45.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |

## Response Type

This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` getter of this instance returns the response data which is of type [`ResponseSignaturesCollection`](../../doc/models/response-signatures-collection.md).
...
signaturesController.listallsignaturesrecordAsync(page, order, filterBy, null, null, null, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
# Viewsinglesignaturerecord

```java
CompletableFuture<ApiResponse<ResponseSignature>> viewsinglesignaturerecordAsync(
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `signatureId` | `String` | Template, Required | Signature ID<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
| `expand` | [`List<Expand34>`](../../doc/models/expand-34.md) | Query, Optional | Most endpoints in the API have a way to retrieve extra data related to the current record being retrieved. For example, if the API request is for the accountvaults endpoint, and the end user also needs to know which contact the token belongs to, this data can be returned in the accountvaults endpoint request.<br><br>**Constraints**: *Unique Items Required* |
| `fields` | [`List<Field45>`](../../doc/models/field-45.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
...
signaturesController.viewsinglesignaturerecordAsync(signatureId, null, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
