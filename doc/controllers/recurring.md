...
```java
String recurringId = "11e95f8ec39de8fbdb0a4f1a";
V1RecurringsRequest1 body = new V1RecurringsRequest1.Builder()
...
```java
String recurringId = "11e95f8ec39de8fbdb0a4f1a";
V1RecurringsDeferPaymentRequest body = new V1RecurringsDeferPaymentRequest.Builder(
    5
)
.build();
...
```java
String recurringId = "11e95f8ec39de8fbdb0a4f1a";
V1RecurringsSkipPaymentRequest body = new V1RecurringsSkipPaymentRequest.Builder(
    7
)
.build();
