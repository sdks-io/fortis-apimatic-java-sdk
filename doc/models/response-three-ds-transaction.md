...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type46Enum`](../../doc/models/type-46-enum.md) | Optional | Resource Type<br><br>**Default**: `Type46Enum.THREEDSTRANSACTION` | Type46Enum getType() | setType(Type46Enum type) |
