...
| `RedirectUrlDelay` | `Double` | Optional | Redirect URL Delay in seconds<br><br>**Constraints**: `<= 15` | Double getRedirectUrlDelay() | setRedirectUrlDelay(Double redirectUrlDelay) |
