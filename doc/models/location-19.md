...
| `PhoneNumber` | `String` | Required | Merchant's business phone number.<br><br>**Constraints**: *Maximum Length*: `20` | String getPhoneNumber() | setPhoneNumber(String phoneNumber) |
