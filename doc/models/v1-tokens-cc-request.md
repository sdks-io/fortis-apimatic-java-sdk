...
| `AccountNumber` | `String` | Optional | Account number<br><br>> For CC transactions, a credit card number. For ACH transactions, a bank account number. String lengths are conditional, CC should be 13-19 and ACH should be 4-19. | String getAccountNumber() | setAccountNumber(String accountNumber) |
...
| `Joi` | [`Joi19`](../../doc/models/joi-19.md) | Optional | - | Joi19 getJoi() | setJoi(Joi19 joi) |
| `ExpDate` | `String` | Optional | Required for CC. The Expiration Date for the credit card. (MMYY format).<br><br>**Constraints**: *Pattern*: `^(0[1-9]\|1[0-2])[0-9]{2}$` | String getExpDate() | setExpDate(String expDate) |
