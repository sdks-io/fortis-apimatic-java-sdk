...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type11Enum`](../../doc/models/type-11-enum.md) | Optional | Resource Type<br><br>**Default**: `Type11Enum.CONTACTSCOLLECTION` | Type11Enum getType() | setType(Type11Enum type) |
