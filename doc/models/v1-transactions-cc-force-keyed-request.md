...
| `AccountNumber` | `String` | Required | For CC transactions, a credit card number. For ACH transactions, a bank account number.<br><br>> String lengths are conditional, CC should be 13-19 and ACH should be 4-19. Required if account_vault_id , track_data, or micr_data is not provided.<br><br>**Constraints**: *Minimum Length*: `13`, *Maximum Length*: `19` | String getAccountNumber() | setAccountNumber(String accountNumber) |
...
| `ExpDate` | `String` | Required | Required for CC. The Expiration Date for the credit card. (MMYY format).<br><br>**Constraints**: *Maximum Length*: `4` | String getExpDate() | setExpDate(String expDate) |
