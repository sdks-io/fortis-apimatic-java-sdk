...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type94Enum`](../../doc/models/type-94-enum.md) | Optional | Resource Type<br><br>**Default**: `Type94Enum.TOKENSCOLLECTION` | Type94Enum getType() | setType(Type94Enum type) |
