...
| `RoutingNumber` | `String` | Required | This field is read only for ach on transactions. Must be supplied if account_vault_id is not provided. | String getRoutingNumber() | setRoutingNumber(String routingNumber) |
