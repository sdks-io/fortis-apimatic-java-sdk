...
| `IntervalType` | [`IntervalType`](../../doc/models/interval-type.md) | Required | - | IntervalType getIntervalType() | setIntervalType(IntervalType intervalType) |
...
| `PaymentMethod` | `Object` | Optional | - | Object getPaymentMethod() | setPaymentMethod(Object paymentMethod) |
