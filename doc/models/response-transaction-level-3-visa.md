...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type115Enum`](../../doc/models/type-115-enum.md) | Optional | Resource Type<br><br>**Default**: `Type115Enum.TRANSACTIONLEVEL3VISA` | Type115Enum getType() | setType(Type115Enum type) |
