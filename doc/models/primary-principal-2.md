...
|  --- | --- | --- | --- | --- | --- |
| `FirstName` | `String` | Required | Signer's first name<br><br>**Constraints**: *Maximum Length*: `20` | String getFirstName() | setFirstName(String firstName) |
| `LastName` | `String` | Required | Signer's last name<br><br>**Constraints**: *Maximum Length*: `20` | String getLastName() | setLastName(String lastName) |
