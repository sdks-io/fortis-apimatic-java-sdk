...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type130Enum`](../../doc/models/type-130-enum.md) | Optional | Resource Type<br><br>**Default**: `Type130Enum.USERSCOLLECTION` | Type130Enum getType() | setType(Type130Enum type) |
