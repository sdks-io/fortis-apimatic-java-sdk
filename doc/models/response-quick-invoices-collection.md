...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type62Enum`](../../doc/models/type-62-enum.md) | Optional | Resource Type<br><br>**Default**: `Type62Enum.QUICKINVOICESCOLLECTION` | Type62Enum getType() | setType(Type62Enum type) |
| `List` | [`List<List10>`](../../doc/models/list-10.md) | Optional | Resource Members | List<List10> getList() | setList(List<List10> list) |
