...
| `IdentityVerification` | [`IdentityVerification`](../../doc/models/identity-verification.md) | Optional | Identity Verification | IdentityVerification getIdentityVerification() | setIdentityVerification(IdentityVerification identityVerification) |
...
| `InitiationType` | [`InitiationTypeEnum`](../../doc/models/initiation-type-enum.md) | Optional | Initiation Type | InitiationTypeEnum getInitiationType() | setInitiationType(InitiationTypeEnum initiationType) |
...
| `AccountNumber` | [`V1TransactionsCcRefundKeyedRequestAccountNumber`](../../doc/models/containers/v1-transactions-cc-refund-keyed-request-account-number.md) | Optional | This is a container for any-of cases. | V1TransactionsCcRefundKeyedRequestAccountNumber getAccountNumber() | setAccountNumber(V1TransactionsCcRefundKeyedRequestAccountNumber accountNumber) |
| `Cvv` | `String` | Optional | Required for CC transactions if vt_require_cvv is true on producttransaction(Merchant Deposit Account).<br><br>**Constraints**: *Maximum Length*: `4` | String getCvv() | setCvv(String cvv) |
...
| `ExpDate` | [`V1TransactionsCcRefundKeyedRequestExpDate`](../../doc/models/containers/v1-transactions-cc-refund-keyed-request-exp-date.md) | Optional | This is a container for any-of cases. | V1TransactionsCcRefundKeyedRequestExpDate getExpDate() | setExpDate(V1TransactionsCcRefundKeyedRequestExpDate expDate) |
...
| `Pin` | `String` | Optional | Pin | String getPin() | setPin(String pin) |
| `Ksn` | `String` | Optional | KSN (Key Serial Number) | String getKsn() | setKsn(String ksn) |
| `PreviousTransactionId` | `String` | Optional | previous_transaction_id is used as token to run transaction. Account details OR previous_transaction_id should be passed to run transaction.<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` | String getPreviousTransactionId() | setPreviousTransactionId(String previousTransactionId) |
