...
| `CardDataCryptogram` | `String` | Required | Encrypted Cardholder data. Used in Tap to Pay transactions | String getCardDataCryptogram() | setCardDataCryptogram(String cardDataCryptogram) |
| `GeneralCardData` | `String` | Required | Plaintext EMV tags. Used in Tap to Pay transactions | String getGeneralCardData() | setGeneralCardData(String generalCardData) |
| `CardReaderId` | `String` | Optional | Identifier of card reader used in Tap to Pay transactions. | String getCardReaderId() | setCardReaderId(String cardReaderId) |
