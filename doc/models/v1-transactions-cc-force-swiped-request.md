...
# V1 Transactions Cc Force Swiped Request

## Structure

`V1TransactionsCcForceSwipedRequest`
...
| `TrackData` | `String` | Required | Track Data from a magnetic card swipe.<br><br>**Constraints**: *Maximum Length*: `256` | String getTrackData() | setTrackData(String trackData) |
