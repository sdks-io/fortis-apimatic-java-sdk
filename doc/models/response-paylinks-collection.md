...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type54Enum`](../../doc/models/type-54-enum.md) | Optional | Resource Type<br><br>**Default**: `Type54Enum.PAYLINKSCOLLECTION` | Type54Enum getType() | setType(Type54Enum type) |
| `List` | [`List<List9>`](../../doc/models/list-9.md) | Optional | Resource Members | List<List9> getList() | setList(List<List9> list) |
