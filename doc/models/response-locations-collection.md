...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type35Enum`](../../doc/models/type-35-enum.md) | Optional | Resource Type<br><br>**Default**: `Type35Enum.LOCATIONSCOLLECTION` | Type35Enum getType() | setType(Type35Enum type) |
| `List` | [`List<List6>`](../../doc/models/list-6.md) | Optional | Resource Members | List<List6> getList() | setList(List<List6> list) |
