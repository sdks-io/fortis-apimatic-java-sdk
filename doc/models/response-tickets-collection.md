...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type88Enum`](../../doc/models/type-88-enum.md) | Optional | Resource Type<br><br>**Default**: `Type88Enum.TICKETSCOLLECTION` | Type88Enum getType() | setType(Type88Enum type) |
