...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type39Enum`](../../doc/models/type-39-enum.md) | Optional | Resource Type<br><br>**Default**: `Type39Enum.LOCATIONINFOSCOLLECTION` | Type39Enum getType() | setType(Type39Enum type) |
