...
| `FreightAmount` | `Integer` | Optional | Freight or shipping portion of the total transaction amount ,Can accept Two (2) decimal places.<br><br>**Constraints**: `>= 0`, `<= 999999999900` | Integer getFreightAmount() | setFreightAmount(Integer freightAmount) |
...
| `LineItems` | [`List<LineItem20>`](../../doc/models/line-item-20.md) | Required | Array of line items in transaction | List<LineItem20> getLineItems() | setLineItems(List<LineItem20> lineItems) |
