...
|  --- | --- | --- | --- | --- | --- |
| `PostbackStatusId` | [`PostbackStatusIdEnum`](../../doc/models/postback-status-id-enum.md) | Optional | Postback Status Id | PostbackStatusIdEnum getPostbackStatusId() | setPostbackStatusId(PostbackStatusIdEnum postbackStatusId) |
