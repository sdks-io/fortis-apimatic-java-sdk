...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type5Enum`](../../doc/models/type-5-enum.md) | Optional | Resource Type<br><br>**Default**: `Type5Enum.TRANSACTIONPROCESSING` | Type5Enum getType() | setType(Type5Enum type) |
