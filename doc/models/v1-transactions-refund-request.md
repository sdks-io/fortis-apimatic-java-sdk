...
| `TransactionAmount` | `Integer` | Optional | Amount of the transaction. This should always be the desired settle amount of the transaction. Use only integer numbers, so $10.99 will be 1099.<br><br>**Constraints**: `>= 1`, `<= 999999999` | Integer getTransactionAmount() | setTransactionAmount(Integer transactionAmount) |
