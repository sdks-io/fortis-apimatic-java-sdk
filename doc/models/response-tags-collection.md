...
|  --- | --- | --- | --- | --- | --- |
| `Type` | [`Type78Enum`](../../doc/models/type-78-enum.md) | Optional | Resource Type<br><br>**Default**: `Type78Enum.TAGSCOLLECTION` | Type78Enum getType() | setType(Type78Enum type) |
| `List` | [`List<List13>`](../../doc/models/list-13.md) | Optional | Resource Members | List<List13> getList() | setList(List<List13> list) |
