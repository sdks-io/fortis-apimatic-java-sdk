...
| `ReasonCodeId` | [`ReasonCodeIdEnum`](../../doc/models/reason-code-id-enum.md) | Optional | Reason Code Id | ReasonCodeIdEnum getReasonCodeId() | setReasonCodeId(ReasonCodeIdEnum reasonCodeId) |
