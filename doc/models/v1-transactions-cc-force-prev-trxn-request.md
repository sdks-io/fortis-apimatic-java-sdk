...
| `PreviousTransactionApiId` | `String` | Optional | previous_transaction_api_id is used as token to run transaction. Account details OR previous_transaction_api_id should be passed to run transaction.<br><br>**Constraints**: *Maximum Length*: `36` | String getPreviousTransactionApiId() | setPreviousTransactionApiId(String previousTransactionApiId) |
| `Joi` | [`Joi27`](../../doc/models/joi-27.md) | Optional | - | Joi27 getJoi() | setJoi(Joi27 joi) |
...
| `AuthCode` | `String` | Required | Required on force transactions and EBT voucher clear sale/refund. Ignored for all other actions.<br><br>**Constraints**: *Maximum Length*: `6` | String getAuthCode() | setAuthCode(String authCode) |
| `TransId` | `String` | Optional | Trans ID<br><br>**Constraints**: *Maximum Length*: `15` | String getTransId() | setTransId(String transId) |
