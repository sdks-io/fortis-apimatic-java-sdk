...
public class V1QuickInvoicesRequest1 {
    ...
    private List<ItemList5> itemList;
     ...
     * @param  itemList  List of ItemList5 value for itemList.
     ...
     * @param  files  List of File5 value for files.
    ...
    protected V1QuickInvoicesRequest1(OptionalNullable<String> locationId,
            OptionalNullable<String> title, OptionalNullable<String> ccProductTransactionId,
            OptionalNullable<String> achProductTransactionId, OptionalNullable<String> dueDate,
            List<ItemList5> itemList, Boolean allowOverpayment,
            ...
            Boolean sendTextToPay, List<File5> files, OptionalNullable<Integer> remainingBalance,
     ...
     * Getter for ItemList.
     * Item List
     * @return Returns the List of ItemList5
     */
    @JsonGetter("item_list")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<ItemList5> getItemList() {
        return itemList;
    }
     ...
     * Setter for ItemList.
     * Item List
     * @param itemList Value for List of ItemList5
     */
    @JsonSetter("item_list")
    public void setItemList(List<ItemList5> itemList) {
        this.itemList = itemList;
    }
     ...
     * @return Returns the List of File5
     */
    @JsonGetter("files")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<File5> getFiles() {
        return files;
    }
     ...
     * Setter for Files.
     * Files &gt;Maximum of 4 files &amp; maximum size of 5MB per file. &gt;
     * @param files Value for List of File5
     */
    @JsonSetter("files")
    public void setFiles(List<File5> files) {
        this.files = files;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder itemList(List<ItemList5> itemList) {
            this.itemList = itemList;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder files(List<File5> files) {
            this.files = files;
            return this;
        }
        ...
        public V1QuickInvoicesRequest1 build() {
            V1QuickInvoicesRequest1 model =
                    new V1QuickInvoicesRequest1(locationId, title, ccProductTransactionId,
