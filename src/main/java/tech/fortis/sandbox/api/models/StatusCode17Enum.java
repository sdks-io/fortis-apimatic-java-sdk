...
public enum StatusCode17Enum {
    ...
    private static TreeMap<Integer, StatusCode17Enum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static StatusCode17Enum constructFromInteger(Integer toConvert) throws IOException {
        StatusCode17Enum enumValue = fromInteger(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given integer value.
     */
    public static StatusCode17Enum fromInteger(Integer toConvert) {
    ...
    /**
     * Convert list of StatusCode17Enum values to list of integer values.
     * @param toConvert The list of StatusCode17Enum values to convert.
     * @return List of representative integer values.
     */
    public static List<Integer> toValue(List<StatusCode17Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<Integer> convertedValues = new ArrayList<>();
        for (StatusCode17Enum enumValue : toConvert) {
