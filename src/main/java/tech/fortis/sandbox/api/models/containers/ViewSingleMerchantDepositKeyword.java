 ...
 */
@JsonDeserialize(using = ViewSingleMerchantDepositKeyword.ViewSingleMerchantDepositKeywordDeserializer.class)
public abstract class ViewSingleMerchantDepositKeyword {
     ...
     */
    public static ViewSingleMerchantDepositKeyword fromString(String string) {
     ...
     */
    public static ViewSingleMerchantDepositKeyword fromPrecision(double precision) {
    ...
    private static class StringCase extends ViewSingleMerchantDepositKeyword {
    ...
    private static class PrecisionCase extends ViewSingleMerchantDepositKeyword {
    ...
    /**
     * This is a custom deserializer class for ViewSingleMerchantDepositKeyword.
     */
    protected static class ViewSingleMerchantDepositKeywordDeserializer
            extends JsonDeserializer<ViewSingleMerchantDepositKeyword> {

        @Override
        public ViewSingleMerchantDepositKeyword deserialize(JsonParser jp, DeserializationContext ctxt)
                throws IOException, JsonProcessingException {
            ObjectCodec oc = jp.getCodec();
            JsonNode node = oc.readTree(jp);
            return ApiHelper.deserialize(node, Arrays.asList(StringCase.class,
                    PrecisionCase.class), false);
        }
    }
