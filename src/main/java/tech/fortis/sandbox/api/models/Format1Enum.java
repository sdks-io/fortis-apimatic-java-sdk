...
public enum Format1Enum {
    ...
    private static TreeMap<String, Format1Enum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static Format1Enum constructFromString(String toConvert) throws IOException {
        Format1Enum enumValue = fromString(toConvert);
        if (enumValue == null) {
