...
public class V1WebhooksBatchRequest {
    ...
    public static class Builder {
        ...
        public V1WebhooksBatchRequest build() {
            V1WebhooksBatchRequest model =
                    new V1WebhooksBatchRequest(isActive, locationId, onCreate, onUpdate, onDelete,
                            productTransactionId, numberOfAttempts, url, attemptInterval,
