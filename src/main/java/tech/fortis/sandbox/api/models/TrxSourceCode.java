...
/**
 * TrxSourceCode to be used.
 */
public enum TrxSourceCode {
    ENUM_1,
    ...
    private static TreeMap<Integer, TrxSourceCode> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static TrxSourceCode constructFromInteger(Integer toConvert) throws IOException {
        TrxSourceCode enumValue = fromInteger(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given integer value.
     */
    public static TrxSourceCode fromInteger(Integer toConvert) {
    ...
    /**
     * Convert list of TrxSourceCode values to list of integer values.
     * @param toConvert The list of TrxSourceCode values to convert.
     * @return List of representative integer values.
     */
    public static List<Integer> toValue(List<TrxSourceCode> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<Integer> convertedValues = new ArrayList<>();
        for (TrxSourceCode enumValue : toConvert) {
