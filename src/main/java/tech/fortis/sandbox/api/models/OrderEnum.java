...
public enum OrderEnum {
    ...
    private static TreeMap<String, OrderEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static OrderEnum constructFromString(String toConvert) throws IOException {
        OrderEnum enumValue = fromString(toConvert);
        if (enumValue == null) {
