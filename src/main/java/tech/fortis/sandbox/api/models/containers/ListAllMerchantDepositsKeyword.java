 ...
 */
@JsonDeserialize(using = ListAllMerchantDepositsKeyword.ListAllMerchantDepositsKeywordDeserializer.class)
public abstract class ListAllMerchantDepositsKeyword {
     ...
     */
    public static ListAllMerchantDepositsKeyword fromString(String string) {
     ...
     */
    public static ListAllMerchantDepositsKeyword fromPrecision(double precision) {
    ...
    private static class StringCase extends ListAllMerchantDepositsKeyword {
    ...
    private static class PrecisionCase extends ListAllMerchantDepositsKeyword {
    ...
    /**
     * This is a custom deserializer class for ListAllMerchantDepositsKeyword.
     */
    protected static class ListAllMerchantDepositsKeywordDeserializer
            extends JsonDeserializer<ListAllMerchantDepositsKeyword> {

        @Override
        public ListAllMerchantDepositsKeyword deserialize(JsonParser jp, DeserializationContext ctxt)
