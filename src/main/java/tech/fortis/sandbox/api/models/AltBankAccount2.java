...
/**
 * This is a model class for AltBankAccount2 type.
 */
public class AltBankAccount2 {
    ...
    private OptionalNullable<String> depositType;
     ...
     * @param  depositType  String value for depositType.
     */
    public AltBankAccount2(
        ...
        this.depositType = OptionalNullable.of(depositType);
    }
    ...
    protected AltBankAccount2(OptionalNullable<String> routingNumber,
            OptionalNullable<String> accountNumber, OptionalNullable<String> accountHolderName,
            OptionalNullable<String> depositType) {
    ...
    /**
     * Internal Getter for DepositType.
     * Deposit type.
     * @return Returns the Internal String
     */
    @JsonGetter("deposit_type")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonSerialize(using = OptionalNullable.Serializer.class)
    protected OptionalNullable<String> internalGetDepositType() {
        return this.depositType;
    }

    /**
     * Getter for DepositType.
     * Deposit type.
     * @return Returns the String
     */
    public String getDepositType() {
        return OptionalNullable.getFrom(depositType);
    }

    /**
     * Setter for DepositType.
     * Deposit type.
     * @param depositType Value for String
     */
    @JsonSetter("deposit_type")
    public void setDepositType(String depositType) {
        this.depositType = OptionalNullable.of(depositType);
    }

    /**
     * UnSetter for DepositType.
     * Deposit type.
     */
    ...
    /**
     * Converts this AltBankAccount2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AltBankAccount2 [" + "routingNumber=" + routingNumber + ", accountNumber="
                + accountNumber + ", accountHolderName=" + accountHolderName + ", depositType="
                + depositType + ", additionalProperties=" + additionalProperties + "]";
    }

    /**
     * Builds a new {@link AltBankAccount2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AltBankAccount2.Builder} object
     */
    public Builder toBuilder() {
        ...
        builder.depositType = internalGetDepositType();
        builder.additionalProperties = additionalProperties;
        return builder;
    }

    /**
     * Class to build instances of {@link AltBankAccount2}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder unsetDepositType() {
            depositType = null;
            return this;
        }
        ...
        /**
         * Builds a new {@link AltBankAccount2} object using the set fields.
         * @return {@link AltBankAccount2}
         */
        public AltBankAccount2 build() {
            AltBankAccount2 model =
                    new AltBankAccount2(routingNumber, accountNumber, accountHolderName,
                            depositType);
