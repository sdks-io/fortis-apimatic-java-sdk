...
public enum TrxSourceCodeEnum {
    ...
    private static TreeMap<Integer, TrxSourceCodeEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static TrxSourceCodeEnum constructFromInteger(Integer toConvert) throws IOException {
        TrxSourceCodeEnum enumValue = fromInteger(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given integer value.
     */
    public static TrxSourceCodeEnum fromInteger(Integer toConvert) {
    ...
    /**
     * Convert list of TrxSourceCodeEnum values to list of integer values.
     * @param toConvert The list of TrxSourceCodeEnum values to convert.
     * @return List of representative integer values.
     */
    public static List<Integer> toValue(List<TrxSourceCodeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<Integer> convertedValues = new ArrayList<>();
        for (TrxSourceCodeEnum enumValue : toConvert) {
