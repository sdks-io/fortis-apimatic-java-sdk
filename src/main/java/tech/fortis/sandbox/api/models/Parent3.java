...
public class Parent3
    ...
    protected Parent3(String id, Integer createdTs, Integer modifiedTs,
    ...
    public String toString() {
        return "Parent3 [" + "id=" + id + ", createdTs=" + createdTs + ", modifiedTs=" + modifiedTs
    ...
    public static class Builder {
        ...
        public Parent3 build() {
            return new Parent3(id, createdTs, modifiedTs, accountNumber, address, brandingDomainId,
