...
public class V1UsersRequest {
    ...
    protected V1UsersRequest(String email, String lastName, String primaryLocationId,
            String username, UserTypeCode userTypeCode, OptionalNullable<String> accountNumber,
            ...
            UiPrefs1 uiPrefs, OptionalNullable<String> userApiKey,
            ...
            Object statusCode, Boolean apiOnly, Boolean isInvitation, Address3 address) {
    ...
    public static class Builder {
        ...
        public V1UsersRequest build() {
            V1UsersRequest model =
                    new V1UsersRequest(email, lastName, primaryLocationId, username, userTypeCode,
                            ...
                            officePhone, officeExtPhone, requiresNewPassword, termsConditionCode,
                            tz, uiPrefs, userApiKey, userHashKey, password, zip, locationId,
