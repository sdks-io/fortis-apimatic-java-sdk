...
/**
 * This is a model class for Address4 type.
 */
public class Address4 {
    ...
    protected Address4(OptionalNullable<String> city, OptionalNullable<String> state,
            OptionalNullable<String> postalCode, OptionalNullable<String> country,
     ...
     * The alpha 2 or alpha 3 format country code. If alpha 3 is provided, it will be converted to
     * alpha 2.
     * @return Returns the Internal String
     */
    @JsonGetter("country")
    ...
    /**
     * Converts this Address4 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Address4 [" + "city=" + city + ", state=" + state + ", postalCode=" + postalCode
                + ", country=" + country + ", street=" + street + ", additionalProperties="
                + additionalProperties + "]";
    }

    /**
     * Builds a new {@link Address4.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Address4.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Address4}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Address4} object using the set fields.
         * @return {@link Address4}
         */
        public Address4 build() {
            Address4 model =
                    new Address4(city, state, postalCode, country, street);
