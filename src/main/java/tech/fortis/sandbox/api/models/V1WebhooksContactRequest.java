...
public class V1WebhooksContactRequest {
    ...
    protected V1WebhooksContactRequest(boolean isActive, String locationId, boolean onCreate,
            ...
            Object format, OptionalNullable<String> locationApiId, Boolean legacy,
    ...
    public static class Builder {
        ...
        public V1WebhooksContactRequest build() {
            V1WebhooksContactRequest model =
                    new V1WebhooksContactRequest(isActive, locationId, onCreate, onUpdate, onDelete,
                            numberOfAttempts, url, attemptInterval, basicAuthUsername,
                            basicAuthPassword, expands, format, locationApiId, legacy,
                            postbackConfigId, productTransactionId, resource);
