...
public class V1WebhooksContactRequest
    ...
    protected V1WebhooksContactRequest(boolean isActive, String locationId, boolean onCreate,
            boolean onUpdate, boolean onDelete, int numberOfAttempts, String url,
            OptionalNullable<Integer> attemptInterval, OptionalNullable<String> basicAuthUsername,
            OptionalNullable<String> basicAuthPassword, OptionalNullable<String> expands,
            OptionalNullable<FormatEnum> format, OptionalNullable<String> locationApiId,
            Boolean legacy, OptionalNullable<String> postbackConfigId,
    ...
    public String toString() {
        return "V1WebhooksContactRequest [" + "isActive=" + isActive + ", locationId=" + locationId
                ...
                + productTransactionId + ", resource=" + resource + ", additionalProperties="
    ...
    public static class Builder {
        ...
        public Builder(boolean isActive, String locationId, boolean onCreate, boolean onUpdate,
                boolean onDelete, int numberOfAttempts, String url) {
            this.isActive = isActive;
            this.locationId = locationId;
            this.onCreate = onCreate;
            this.onUpdate = onUpdate;
        ...
        public V1WebhooksContactRequest build() {
            return new V1WebhooksContactRequest(isActive, locationId, onCreate, onUpdate, onDelete,
                    ...
                    expands, format, locationApiId, legacy, postbackConfigId, productTransactionId,
                    resource);
        }
    }
}
