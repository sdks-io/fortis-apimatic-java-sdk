...
public class V1QuickInvoicesRequest
    ...
    public String toString() {
        return "V1QuickInvoicesRequest [" + "title=" + title + ", dueDate=" + dueDate
                ...
                + autoReopen + ", additionalProperties=" + getAdditionalProperties() + "]";
    }
    ...
    public static class Builder {
        ...
        public V1QuickInvoicesRequest build() {
            return new V1QuickInvoicesRequest(title, dueDate, itemList, locationId,
                    ...
                    quickInvoiceC2, quickInvoiceC3, autoReopen);
        }
    }
}
