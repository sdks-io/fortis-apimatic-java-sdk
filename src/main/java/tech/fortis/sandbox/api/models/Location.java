...
public class Location
    ...
    protected Location(String id, Integer createdTs, Integer modifiedTs,
    ...
    public String toString() {
        return "Location [" + "id=" + id + ", createdTs=" + createdTs + ", modifiedTs=" + modifiedTs
    ...
    public static class Builder {
        ...
        public Location build() {
            return new Location(id, createdTs, modifiedTs, accountNumber, address, brandingDomainId,
