...
/**
 * This is a model class for QuickInvoice type.
 */
public class QuickInvoice
    ...
    protected QuickInvoice(OptionalNullable<String> locationId, String title,
            ...
            Boolean sendTextToPay, List<File2> files, OptionalNullable<Double> remainingBalance,
    ...
    /**
     * Converts this QuickInvoice into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "QuickInvoice [" + "locationId=" + locationId + ", title=" + title
                ...
                + ", isActive=" + isActive + ", additionalProperties=" + getAdditionalProperties()
                + "]";
    }

    /**
     * Builds a new {@link QuickInvoice.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link QuickInvoice.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link QuickInvoice}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link QuickInvoice} object using the set fields.
         * @return {@link QuickInvoice}
         */
        public QuickInvoice build() {
            return new QuickInvoice(locationId, title, ccProductTransactionId,
                    achProductTransactionId, dueDate, itemList, allowOverpayment,
                    bankFundedOnlyOverride, email, contactId, contactApiId, quickInvoiceApiId,
                    customerId, expireDate, allowPartialPay, attachFilesToEmail, sendEmail,
                    invoiceNumber, itemHeader, itemFooter, amountDue, notificationEmail, statusId,
                    statusCode, note, notificationDaysBeforeDueDate, notificationDaysAfterDueDate,
                    notificationOnDueDate, sendTextToPay, files, remainingBalance,
                    singlePaymentMinAmount, singlePaymentMaxAmount, cellPhone, tags, quickInvoiceC1,
                    quickInvoiceC2, quickInvoiceC3, autoReopen, id, createdTs, modifiedTs,
                    createdUserId, modifiedUserId, active, paymentStatusId, isActive);
        }
    }
}
