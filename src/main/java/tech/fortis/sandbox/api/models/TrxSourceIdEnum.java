...
public enum TrxSourceIdEnum {
    ...
    private static TreeMap<Integer, TrxSourceIdEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static TrxSourceIdEnum constructFromInteger(Integer toConvert) throws IOException {
        TrxSourceIdEnum enumValue = fromInteger(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given integer value.
     */
    public static TrxSourceIdEnum fromInteger(Integer toConvert) {
    ...
    /**
     * Convert list of TrxSourceIdEnum values to list of integer values.
     * @param toConvert The list of TrxSourceIdEnum values to convert.
     * @return List of representative integer values.
     */
    public static List<Integer> toValue(List<TrxSourceIdEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
