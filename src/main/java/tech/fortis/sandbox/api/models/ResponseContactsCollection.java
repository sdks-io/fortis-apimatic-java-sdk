...
public class ResponseContactsCollection {
     ...
     * @param  type  Type11 value for type.
    ...
    /**
     * Setter for Type.
     * @param type Value for Type11
     */
    @JsonSetter("type")
    public void setType(Type11 type) {
        this.type = type;
    }
    ...
    public String toString() {
        return "ResponseContactsCollection [" + "type=" + type + ", list=" + list + ", links="
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder type(Type11 type) {
            this.type = type;
            return this;
        }
        ...
        public ResponseContactsCollection build() {
            ResponseContactsCollection model =
                    new ResponseContactsCollection(type, list, links, pagination, sort);
