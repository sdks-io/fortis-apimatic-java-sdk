...
public class ResponseTransactionsCollection {
    private Type117 type;
    private List<List18> list;
     ...
     * @param  type  Type117 value for type.
     * @param  list  List of List18 value for list.
    ...
    /**
     * Getter for Type.
     * @return Returns the Type117
     */
    @JsonGetter("type")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Type117 getType() {
        return type;
    }

    /**
     * Setter for Type.
     * @param type Value for Type117
     */
    @JsonSetter("type")
    public void setType(Type117 type) {
        this.type = type;
    }
     ...
     * Getter for List.
     * Resource Members
     * @return Returns the List of List18
     */
    @JsonGetter("list")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<List18> getList() {
        return list;
    }
     ...
     * Setter for List.
     * Resource Members
     * @param list Value for List of List18
     */
    @JsonSetter("list")
    public void setList(List<List18> list) {
        this.list = list;
    }
    ...
    public String toString() {
        return "ResponseTransactionsCollection [" + "type=" + type + ", list=" + list + ", links="
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder type(Type117 type) {
            this.type = type;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder list(List<List18> list) {
            this.list = list;
            return this;
        }
        ...
        public ResponseTransactionsCollection build() {
            ResponseTransactionsCollection model =
                    new ResponseTransactionsCollection(type, list, links, pagination, sort);
