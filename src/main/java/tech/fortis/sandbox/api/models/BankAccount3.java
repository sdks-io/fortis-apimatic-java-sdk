...
/**
 * This is a model class for BankAccount3 type.
 */
public class BankAccount3 {
    ...
    protected BankAccount3(OptionalNullable<String> routingNumber,
    ...
    /**
     * Converts this BankAccount3 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BankAccount3 [" + "routingNumber=" + routingNumber + ", accountNumber="
                + accountNumber + ", accountHolderName=" + accountHolderName
                + ", additionalProperties=" + additionalProperties + "]";
    }

    /**
     * Builds a new {@link BankAccount3.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BankAccount3.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BankAccount3}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BankAccount3} object using the set fields.
         * @return {@link BankAccount3}
         */
        public BankAccount3 build() {
            BankAccount3 model =
                    new BankAccount3(routingNumber, accountNumber, accountHolderName);
