...
public class V1DeviceTermsRequest {
    ...
    protected V1DeviceTermsRequest(String locationId, String terminalId, boolean requireSignature,
            String termsConditions, OptionalNullable<String> deviceTermApiId) {
        this.locationId = locationId;
        this.terminalId = terminalId;
        this.requireSignature = requireSignature;
    ...
    public String toString() {
        return "V1DeviceTermsRequest [" + "locationId=" + locationId + ", terminalId=" + terminalId
                ...
                + ", deviceTermApiId=" + deviceTermApiId + ", additionalProperties="
    ...
    public static class Builder {
        ...
        public V1DeviceTermsRequest build() {
            V1DeviceTermsRequest model =
                    new V1DeviceTermsRequest(locationId, terminalId, requireSignature,
