...
public class ResponseTerminal {
     ...
     * @param  type  Type82 value for type.
    ...
    /**
     * Getter for Type.
     * @return Returns the Type82
     */
    @JsonGetter("type")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Type82 getType() {
        return type;
    }

    /**
     * Setter for Type.
     * @param type Value for Type82
     */
    @JsonSetter("type")
    public void setType(Type82 type) {
        this.type = type;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder type(Type82 type) {
            this.type = type;
            return this;
        }
        ...
        public ResponseTerminal build() {
            ResponseTerminal model =
                    new ResponseTerminal(type, data);
