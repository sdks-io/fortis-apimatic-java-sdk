...
public class ResponseDeviceTerm {
     ...
     * @param  type  Type22 value for type.
    ...
    /**
     * Getter for Type.
     * @return Returns the Type22
     */
    @JsonGetter("type")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Type22 getType() {
        return type;
    }

    /**
     * Setter for Type.
     * @param type Value for Type22
     */
    @JsonSetter("type")
    public void setType(Type22 type) {
        this.type = type;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder type(Type22 type) {
            this.type = type;
            return this;
        }
        ...
        public ResponseDeviceTerm build() {
            ResponseDeviceTerm model =
                    new ResponseDeviceTerm(type, data);
