 ...
 */
@JsonDeserialize(using = FilterByValueCase1.FilterByValueCase1Deserializer.class)
public abstract class FilterByValueCase1 {
     ...
     */
    public static FilterByValueCase1 fromString(String string) {
     ...
     */
    public static FilterByValueCase1 fromBoolean(boolean mBoolean) {
    ...
    private static class PrecisionCase extends FilterByValueCase1 {
    ...
    private static class StringCase extends FilterByValueCase1 {
    ...
    private static class BooleanCase extends FilterByValueCase1 {
    ...
    /**
     * This is a custom deserializer class for FilterByValueCase1.
     */
    protected static class FilterByValueCase1Deserializer
            extends JsonDeserializer<FilterByValueCase1> {

        @Override
        public FilterByValueCase1 deserialize(JsonParser jp, DeserializationContext ctxt)
                throws IOException, JsonProcessingException {
            ObjectCodec oc = jp.getCodec();
            JsonNode node = oc.readTree(jp);
            return ApiHelper.deserialize(node, Arrays.asList(PrecisionCase.class, StringCase.class,
