...
public class User4 {
    ...
    protected User4(OptionalNullable<String> id, OptionalNullable<String> username,
    ...
    public String toString() {
        return "User4 [" + "id=" + id + ", username=" + username + ", firstName=" + firstName
    ...
    public static class Builder {
        ...
        public User4 build() {
            User4 model =
                    new User4(id, username, firstName, lastName);
